...
class Paid extends Component {
    ...
    render() {
      ...
      return (
            <div>
            <br />
            <h4 className="text-center display-4" onClick={this.toggleBtnClick}>Paid{this.state.collapse === true ? <i className="fas fa-caret-up" /> : <i className="fas fa-caret-down" />}</h4>
