...
class Others extends Component {
    ...
    render() {
      ...
      return (
            <div>
            <br />
            <h4 className="text-center display-4" onClick={this.toggleBtnClick}>Others{this.state.collapse === true ? <i className="fas fa-caret-up" /> : <i className="fas fa-caret-down" />}</h4>
